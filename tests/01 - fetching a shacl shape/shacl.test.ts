...
describe('Check whether we can successfully extract a SHACL shape', () => {
  it('Extract a shape from a shape', async () => {
    ...
    let result = await extractor.extract(dataStore, new NamedNode("http://example.org/PersonShape"), new NamedNode("http://www.w3.org/ns/shacl-shacl#ShapeShape"));
